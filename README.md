...
[![hep-forge](https://img.shields.io/badge/package-hep--forge%2Fdd4hep-orange.svg)](https://anaconda.org/hep-forge/dd4hep)
[![Build & Upload](https://github.com/hep-forge/dd4hep-feedstock/actions/workflows/autoupload.yml/badge.svg)](https://github.com/hep-forge/dd4hep-feedstock/actions/workflows/autoupload.yml)
...
```bash
conda install -c hep-forge -c conda-forge dd4hep
```
